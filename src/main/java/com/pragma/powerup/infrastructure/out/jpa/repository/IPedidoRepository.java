...
public interface IPedidoRepository extends JpaRepository<PedidoEntity, Long> {
    ...
    @Query("UPDATE PedidoEntity p SET p.idEmpleadoAsignado = :idEmpleado, p.estado = :estado, p.fechaActualizacion = :fechaActualizacion WHERE p.id = :id")
    int asignarPedidoAEmpleado(@Param("id") Long id, @Param("idEmpleado") Long idEmpleado, @Param("estado") String estado, @Param("fechaActualizacion") LocalDateTime fechaActualizacion);
