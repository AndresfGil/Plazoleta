...
public interface PlatoControllerDocs {
    ...
    ResponseEntity<PlatoResponseDto> guardarPlato(PlatoRequestDto platoRequestDto);
    ...
    ResponseEntity<PlatoResponseDto> actualizarPlato(Long id, PlatoUpdateRequestDto platoUpdateRequestDto);
    ...
    ResponseEntity<PlatoResponseDto> togglePlatoActivo(Long id);
    ...
    ResponseEntity<Page<PlatoListaResponseDto>> obtenerPlatosPaginados(Long idRestaurante, String categoria, int page, int size);
}